...
public class PreparedStatementBinderTest {
    ...
    public void bindRecord() throws SQLException, ParseException {
        ...
        Struct valueStruct = new Struct(valueSchema)
                ...
                .put("created_at", "2016-12-07T22:09:26.166Z");
        ...
        verify(statement, times(1)).setTimestamp(index++, new java.sql.Timestamp((Instant.parse((String)valueStruct.get("created_at")).toEpochMilli())));
    ...
    public void bindFieldStructUnsupported() throws SQLException {
        ...
        PreparedStatementBinder.bindField(mock(PreparedStatement.class), 1, structSchema, new Struct(structSchema), null);
    }

    @Test(expected = ConnectException.class)
    public void bindFieldArrayUnsupported() throws SQLException {
        Schema arraySchema = SchemaBuilder.array(Schema.INT8_SCHEMA);
        PreparedStatementBinder.bindField(mock(PreparedStatement.class), 1, arraySchema, Collections.emptyList(), null);
    }
    ...
    public void bindFieldMapUnsupported() throws SQLException {
        ...
        PreparedStatementBinder.bindField(mock(PreparedStatement.class), 1, mapSchema, Collections.emptyMap(), null);
    }

    private PreparedStatement verifyBindField(int index, Schema schema, Object value) throws SQLException {
        PreparedStatement statement = mock(PreparedStatement.class);
        PreparedStatementBinder.bindField(statement, index, schema, value, null);
